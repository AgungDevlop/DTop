  ...
  return (
    <div className="container mx-auto max-w-2xl p-6 bg-gray-900 text-white rounded-lg shadow-lg">
      ...
      <div className="flex mb-4 border border-gray-700 rounded-lg overflow-hidden">
        ...
        />
        <button onClick={handleCopy} className="bg-blue-500 hover:bg-blue-600 transition-colors text-white p-3">
          <FaCopy />
        </button>
      </div>
      ...
      <div className="flex mb-4 border border-gray-700 rounded-lg overflow-hidden">
        <input
          ...
          className="flex-1 p-3 bg-gray-800 text-white outline-none"
        />
        <button onClick={() => handlePageChange(1)} className="bg-blue-500 hover:bg-blue-600 transition-colors text-white p-3">
          <FaSearch />
        </button>
      </div>
